...
from typing import Any, List, Sequence, Tuple, Set, Optional, Dict
...
class DescriptorsNormalizationParameters:
  """
  A class for holding dictionary of 200 RDKit descriptors and the corresponding distribution functions (based-on `scipy.stats` module nomenclature)
  and associated parameters, required for creating normalised descriptor functions.

  (The distribution functions and parameters data was collected from source code of 'descriptastrous' library)
  """
  try:
  ...
  desc_norm_params: Dict[str, Sequence[str, Tuple[float], float, float, float,
                                       float]]
  desc_norm_params = {
      ...
      'EState_VSA3': ('pearson3', (1.2130333692507862, 20.490424246483514,
      ...
      'PEOE_VSA10': ('ncx2', (1.2634981555275662, 2.1503143438355354,
                              -2.21123444897305e-31, 2.606409115395213), 0.0,
                     494.0556831191233, 9.763622525936078, 12.915305068064065),
      'Chi2v':
          ('fisk', (5.416294252795936, -0.46711733318914683, 7.911730855234288),
           0.0, 152.03415385974233, 7.97051218652611, 4.006279197425447),
      'SMR_VSA8': ('betaprime', (0.12979362790686721, 2.0084510281921832,
                                 -1.7874327445880742e-34, 0.4022005514286884),
                   0.0, 0.0, 0.0, 0.0),
      'ExactMolWt':
          ('mielke', (6.030507225812184, 6.081069808326847, -3.1905715544779594,
                      393.79789827541134), 7.01545597009, 7902.703267132,
           413.2180535712111, 196.11660291127603),
      'fr_imidazole': ('wald', (-0.017711130586117518, 0.05908774988990952), 0,
                       11, 0.10202714189993299, 0.35905461339251266),
      'fr_aldehyde':
      ...
      'fr_Al_COO': ('beta', (0.6951891478660377, 401.3878921392054,
                             -1.8490162599417683e-28, 14.902552079575546), 0, 9,
                    0.05697398817917254, 0.2720833952111172),
      ...
      'NumHAcceptors': ('logistic', (5.039523695264815, 1.2773064178194637), 0,
                        199, 5.285449981498705, 3.9293707904214674),
      'fr_lactam':
          ('halflogistic', (-1.9994772259051099e-10, 0.0019599976691355514), 0,
           2, 0.0019601372096046724, 0.04490322117641692),
      ...
      'NumSaturatedHeterocycles':
          ('halfgennorm', (0.39340463716320073, -3.084884622335595e-23,
           ...
           0.8423690871097294),
      'NumAliphaticRings': ('gennorm', (0.16214999420806342, 1.0000000000000002,
                                        1.2644170558638866e-06), 0, 24,
                            0.9787585130959167, 1.0878564569993276),
      'SMR_VSA4':
      ...
      'fr_halogen': ('exponweib', (1.5936220372251417, 0.4773265592552294,
                                   -6.305557196427465e-30, 0.11136163589207024),
                     0, 22, 0.6656565959617173, 1.1538784657180654),
      ...
      'MolLogP':
          ('nct', (5.423133497140618, -0.2505422147848311, 3.787125066469563,
                   1.447521060093181), -27.121900000000043, 26.476990000000036,
           3.357664737331615, 1.8518910248841818),
      ...
      'SlogP_VSA6': ('dweibull', (1.2651196828193871, 44.8855208417171,
      ...
      'HeavyAtomCount': ('mielke', (5.542942710744559, 6.0129203920305345,
                                    -0.10475651052005365, 28.19145327714555), 1,
                         545, 29.187713139919794, 13.728021647131865),
      ...
      'fr_SH': ('halflogistic', (-5.627308315330754e-10, 0.002940168145955494),
                0, 2, 0.0029402058144070084, 0.057719918625515),
      'fr_ketone_Topliss':
      ...
      'PEOE_VSA2': ('genlogistic', (1025.7536859090253, -32.00326592275044,
                                    5.426751909719114), 0.0, 436.5016359224807,
                    8.968372740727396, 10.688899230076526),
      ...
      'EState_VSA9': ('gompertz', (157762717330.9355, -8.297980815964564e-12,
                                   1740272081706.4692), 0.0, 459.53012783207976,
                      9.405433826279932, 11.29251583636432),
      'SlogP_VSA1': ('betaprime', (24.555424043054373, 8.676784435768978,
      ...
      'fr_quatN':
          ('halflogistic', (-1.8398640615463982e-10, 0.0022802512521409345), 0,
           2, 0.002280159611172782, 0.05094097451844112),
      'fr_dihydropyridine':
      ...
      'fr_ketone': ('wald', (-0.01054998963908324, 0.035036217635414556), 0, 6,
                    0.06421449501465103, 0.27790680727297107),
      'MaxAbsEStateIndex':
      ...
      'fr_benzodiazepine':
          ('tukeylambda', (1.5687789926087756, 0.0024158367934644202,
                           0.0037899140207594472), 0, 1, 0.0019601372096046724,
           0.04423002455034584),
      'EState_VSA5':
      ...
      'PEOE_VSA5': ('gilbrat', (-0.04993824025443838, 0.13664006325267003), 0.0,
                    73.11939707590946, 2.0398397458425537, 4.669463461453408),
      'fr_epoxide': ('hypsecant', (9.775361773901804e-06, 0.004229322664644675),
                     0, 3, 0.0015001050073505146, 0.041205202260121296),
      'fr_prisulfonamd': ('betaprime', (0.12979362790686721, 2.0084510281921832,
                                        -1.7874327445880742e-34,
                                        0.4022005514286884), 0, 0, 0.0, 0.0),
      ...
      'fr_alkyl_halide': ('wald', (-0.04358050576953841, 0.1452321478197392), 0,
                          17, 0.25484783934875443, 0.9066667900753467),
      ...
      'fr_thiazole': ('wald', (-0.007257531762340398, 0.024068128495977677), 0,
                      6, 0.04502315162061344, 0.217339283746722),
      'fr_imide': ('pearson3', (2.2221583002327714, 0.018063449381832734,
                                0.02006992198733707), 0, 6, 0.02752192653485744,
                   0.1778336591269578),
      'NumSaturatedRings':
      ...
      'FractionCSP3':
          ('gausshyper', (0.4771522405083861, 9.066071275571563,
                          ...
                          -4.691817003086665e-28, 1.3215636376781599), 0.0, 1.0,
           0.3432847243844843, 0.19586440800503926),
      ...
      'fr_para_hydroxylation':
          ('gilbrat', (-0.00874073035192809, 0.023988673379858362), 0, 7,
           0.2581980738651706, 0.5588920168597382),
      'HeavyAtomMolWt':
          ('burr', (6.148243331396738, 0.9539656352826273, -2.0597306351675164,
                    373.86535994513247), 6.941, 7542.798000000015,
           389.1014159096795, 184.23918925686846),
      ...
      'fr_allylic_oxid': ('wald', (-0.012125985576272109, 0.04021754130884261),
                          0, 12, 0.07526526856879981, 0.43369194377652315),
      'fr_alkyl_carbamate':
          ('wald', (-0.0028043421468934076, 0.009276348457582401), 0, 3,
           0.018071264988549197, 0.13836470784532925),
      'fr_HOCCN': ('wald', (-0.0019826051357043533, 0.006555328648504729), 0, 2,
                   0.01286090026301841, 0.11373440248499654),
      ...
      'NOCount':
          ('dgamma', (0.9114891050741081, 5.999999999999998, 2.360844051557576),
           0, 237, 6.576580360625244, 5.165410541429347),
      'EState_VSA4': ('foldnorm', (0.005911506485819916, -9.396020384268004e-10,
      ...
      'fr_aniline': ('halfgennorm', (0.1049174054668825, -0.0004210957634456598,
                                     2.0561338188621596e-11), 0, 17,
                     0.6701569109837688, 0.8999932508248457),
      'SMR_VSA3':
          ('dgamma', (1.7525536696583415, 12.349493875194277, 4.09734805299208),
      ...
      'fr_phenol_noOrthoHbond':
          ('invweibull', (0.8136034301945807, -5.137954972709019e-29,
           ...
           0.2514798405151786),
      'PEOE_VSA8':
          ('dgamma', (1.49159666908677, 21.468624511796396, 8.385920333308711),
           0.0, 311.7903524102208, 25.24827589064641, 16.37842558375825),
      ...
      'BalabanJ': ('nct', (4.182658638749994, 2.0965263482828114,
                           1.1271767054584343, 0.2616489125636474), 0.0,
                   7.289359191119452, 1.8039183288289355, 0.47846986656304485),
      ...
      'fr_Imine': ('wald', (-0.004133581140781835, 0.013682691065125839), 0, 4,
                   0.02636184532917304, 0.17166002580284992),
      ...
      'fr_piperzine':
          ('invweibull', (0.7886440189451933, -2.4256731163377907e-29,
           ...
           0.28309044391366156),
      'fr_nitroso':
          ('genhalflogistic', (2.1084981882574176e-07, -4.9280506479729835e-05,
                               0.0027110708397517554), 0, 2,
           0.00014000980068604803, 0.012648778519674015),
      'FpDensityMorgan2':
      ...
      'fr_amidine': ('gompertz', (1256395099718.369, -3.6322380930315925e-14,
                                  17278550801.355766), 0, 4, 0.0163211424799736,
                     0.13976768727132605),
      ...
      'RingCount': ('dgamma', (2.186557671264268, 3.4836909786085286,
                               0.49776105041563334), 0, 57, 3.4596821777524425,
                    1.5775840075847496),
      'fr_azide': ('hypsecant', (0.0011100250221481181, 0.002817992740312428),
                   0, 2, 0.0009900693048513396, 0.03238970929040505),
      'Ipc':
          ('ncf', (2.2307091334463722, 0.10899090116091759, 1.0000000000366653,
                   -1.1981582241278056e+221, 0.5596425180505273), 0.0,
           9.476131257211451e+221, 1.0245870093128289e+217, inf),
      'fr_benzene': ('dgamma', (3.3192814002631734, 1.5061477493525466,
                                0.23910537147076447), 0, 14, 1.5344274099186943,
                     0.9561701389956593),
      'fr_thiocyan':
      ...
      'EState_VSA7': ('powerlaw', (0.2103250937511124, -1.031145487494383e-26,
      ...
      'fr_diazo': ('halfnorm', (-8.299739916759084e-10, 0.0031623214263548586),
                   0, 1, 1.000070004900343e-05, 0.0031623725326093326),
      'MaxEStateIndex':
      ...
      'VSA_EState8': ('cauchy', (0.4615208647039756,
                                 1.4176964379023667), -4.311579244789392,
                      610.9052623831149, 9.971522100585924, 18.488170207714543),
      ...
      'NumHeteroatoms':
          ('genlogistic', (22.144409538152043, -1.4241236643022548,
           ...
           5.484367394332425),
      'fr_pyridine': ('gilbrat', (-0.006105798295798184, 0.016715004503743934),
      ...
      'NumHDonors': ('johnsonsu', (-6.303785805420036, 1.2935688877340756,
                                   -0.44063513396543863, 0.023159008664878106),
                     0, 104, 1.6016621163481444, 2.2472252977995697),
      'NumValenceElectrons':
          ('t', (2.854251470602213, 144.3027466924646, 32.00913472185999), 0,
           2996, 153.57779044533117, 75.10240753520117),
      'Chi0':
          ('fisk', (5.941141785557418, -0.07374276109511947, 19.65464437888598),
           0.0, 405.82501416452726, 20.82806399367901, 9.928368342000695),
      ...
      'NHOHCount': ('invgamma', (3.8797587021158746, -1.1307664222598288,
                                 8.227943634490117), 0, 117, 1.7429120038402688,
                    2.563177769965799),
      ...
      'PEOE_VSA1': ('burr', (3.9268049096073985, 0.48995232102675695,
      ...
      'MinAbsPartialCharge': ('laplace', (0.26315857867884, 0.0561294628943012),
                              0.00017822665335796042, 1.0, 0.2739606546909672,
                              0.07533771658554175),
      'SMR_VSA6': ('recipinvgauss', (0.5082650634594839, -6.086954132180281,
                                     8.524443845355009), 0.0, 817.1820035633156,
                   19.209113622421707, 17.41580422042883),
      'fr_thiophene':
      ...
      'EState_VSA10':
          ('genexpon', (2.705707701965304, 3.771883657629245, 5.375903761907104,
                        -4.354556984551863e-07, 54.16500289129278), 0.0,
           322.991248574887, 11.740129013811245, 11.161898269805397),
      'fr_NH1': ('exponnorm', (2892.636726669909, -0.0012981492832112645,
                               0.00037957863319105643), 0, 70,
                 1.1072875101257087, 1.5590446880501752),
      'SlogP_VSA4': ('halfgennorm', (0.13290288528045635, -2.16370553583873e-12,
                                     4.03300081749346e-08), 0.0,
                     116.32363116174835, 6.358583799897668, 7.800100182361395),
      'fr_Ndealkylation2':
      ...
      'fr_nitro': ('wald', (-0.006030983799621385, 0.019984499845659677), 0, 4,
                   0.03786265038552699, 0.20368952922550065),
      'SlogP_VSA8':
          ('ncf', (0.010351345715274272, 2.238220060195106, 2.3979254167173853,
                   -2.0305306869043397e-08, 0.00093545475888877), 0.0,
           133.9023781814824, 6.766619840611257, 8.671848120645365),
      'VSA_EState2':
      ...
      'PEOE_VSA13': ('halfgennorm', (0.2726011593040699, -6.070628359122943e-24,
                                     0.0023718323492315794), 0.0,
                     78.17764936502758, 3.30010114873348, 4.358778167233281),
      'fr_oxazole': ('wald', (-0.0018806042805029088, 0.006217750403694874), 0,
                     2, 0.012210854759833188, 0.11073284872542345),
      ...
      'fr_morpholine':
          ('exponweib', (1.5683748664994073, 0.5053553495208175,
                         -2.1400950538163005e-30, 0.0033466480252323464), 0, 3,
           0.046923284629924095, 0.21977656974074022),
      'fr_unbrch_alkane':
          ('genhalflogistic', (0.0001735874860695949, -2.406745376333286e-08,
                               0.2558409046054385), 0, 167, 0.2555878911523807,
           1.8216755193439447),
      'fr_amide': ('recipinvgauss', (220103.5665089948, -1.4778017808899836e-11,
                                     0.7451439305459917), 0, 71,
                   1.1422999609972697, 1.6398141260141192),
      'NumRotatableBonds': ('mielke', (2.902960148717509, 4.199193993037961,
                                       -0.9968227721720102, 8.267126836374882),
                            0, 304, 7.140309821687518, 6.233943765856294),
      ...
      'fr_methoxy': ('gilbrat', (-0.01550907507397075, 0.042866902160229356), 0,
                     8, 0.31338193673557146, 0.6523713877037112)
  }
