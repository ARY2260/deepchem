...
def test_dmpnn_regression():
  ...
  """
  torch.manual_seed(0)
  from deepchem.models.torch_models.temp_dmpnn import _MapperDMPNN, DMPNN
  ...
  model = DMPNN(mode='regression', global_features_size=morgan_feature_size, n_tasks = number_of_tasks, number_of_molecules = number_of_molecules)
