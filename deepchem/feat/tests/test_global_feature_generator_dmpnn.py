...
class TestGlobalFeatureGenerator(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.feature_generators = [[''], ['morgan'], ['morgan', ''], ['morgan', 'morgan']]
  ...
  def test_generator_invalid_name(self):
    ...
    """
    global_features = generate_global_features(self.mol[0], self.feature_generators[0])
  ...
  def test_generator_morgan(self):
    ...
    """
    global_features = generate_global_features(self.mol[0], self.feature_generators[1])
  ...
  def test_generator_morgan_with_invalid_name(self):
    ...
    """
    global_features = generate_global_features(self.mol[0], self.feature_generators[2])
    assert len(global_features) == 2048
  ...
  def test_generator_morgan_twice(self):
    ...
    """
    global_features = generate_global_features(self.mol[0], self.feature_generators[3])
  ...
  def test_generator_hydrogen(self):
    ...
    """
    global_features = generate_global_features(self.mol[1], self.feature_generators[2])
